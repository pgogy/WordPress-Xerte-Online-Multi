		...
		if($show){
			...
			if(isset($_GET['preview'])){
				...
				if($_GET['preview']=="true"){
					...
					$string_for_flash_xml =  $wp_dir['baseurl'] . "/xerte-online/" . $post->ID . "/preview.xml?time=" . time();
				
				}
			
			}else{
			
				$string_for_flash_xml = $wp_dir['baseurl'] . "/xerte-online/" . $post->ID . "/data.xml?time=" . time();
			
			}

			$string_for_flash = $wp_dir['baseurl'] . "/xerte-online/" . $post->ID . "/";
			...
			<script type="text/javascript" src = "<?PHP echo network_site_url(); ?>/wp-content/plugins/xerte-online/xertefiles/rloObject.js"></script>
